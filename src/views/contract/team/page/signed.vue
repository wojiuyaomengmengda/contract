    ...
    <div class="ps-a workers">
        ...
        <div class="content">
            ...
            <el-row type="flex" justify="space-between">
                <div>
                    项目
                    <el-input style="width: 400px" class="m-l-20" placeholder="请输入项目名称">
                        <el-button slot="append" icon="el-icon-search"></el-button>
                    </el-input>
                </div>
                <el-button type="primary" @click="cancelList">查看已取消合同</el-button>
            </el-row>
...
<script>
    export default {
        ...
        methods: {
            ...
            // 查看已取消合同
            cancelList() {
                this.$router.push({name:'teamCancelList'});
            }
        },
    }
</script>
