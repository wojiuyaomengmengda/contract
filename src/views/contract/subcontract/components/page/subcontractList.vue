<template>
    ...
    <div class="subcontractList padding-page ps-a workers">
        ...
        <el-table :data="tableData" class="m-t-20" style="width: 100%"  @selection-change="handleSelectionChange" height="80%">
            ...
            <el-table-column
                ...
                label="操作">
                <template slot-scope="scope">
                    <el-button type="text">查看合同文本</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        historyList() {
            console.log('查看历史合同');
            this.$router.push({ name: 'contractHistoryList' });
        }
    }
}
</script>
